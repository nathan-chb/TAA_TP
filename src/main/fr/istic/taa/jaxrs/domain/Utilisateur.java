...
@Entity
@Data
@NamedQuery(name = "Utilisateur.findOne", query = "FROM Utilisateur u WHERE u.utilisateurPK = ?1")
@NamedQuery(name = "Utilisateur.findAll", query = "SELECT e FROM Utilisateur e")
